...
public @interface EventHandler {
     ...
     * When set, the annotated method must be a public static method returning the enclosing component type
     * (or {@code Optional} thereof), and the specified class must be an aggregate root annotated with
