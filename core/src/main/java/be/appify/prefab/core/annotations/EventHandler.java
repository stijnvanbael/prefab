...
public @interface EventHandler {
     ...
     * Any parameter not specified in the mapping will be passed as-is if a property with the same name has been found
     * on the event. Failure to map all parameters or a reference to a non-existent query method will result in a
     * compilation error.
     */
    @Target(ElementType.METHOD)
    @Retention(RetentionPolicy.SOURCE)
