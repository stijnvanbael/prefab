...
class StreamPluginTest {
    ...
    @Test
    @DisplayName("Pull model: @Stream on Stream<String> compiles without errors")
    void pullModel_streamOfString_compilesSuccessfully() {
    ...
    @Test
    @DisplayName("Push model: @Stream on @EventHandler @ByReference compiles without errors")
    void pushModel_compilesSuccessfully() {
        var compilation = javac()
                .withProcessors(new PrefabProcessor())
                .compile(
