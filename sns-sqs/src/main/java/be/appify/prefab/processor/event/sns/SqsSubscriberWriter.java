...
class SqsSubscriberWriter {
    private static final ConsumerWriterSupport support = new ConsumerWriterSupport(Event.Platform.SNS_SQS);
    private final PrefabContext context;

    SqsSubscriberWriter(PrefabContext context) {
        this.context = context;
    }

    void writeSqsSubscriber(
            TypeManifest owner,
        ...
        var type = TypeSpec.classBuilder(name)
                ...
                .addField(FieldSpec.builder(Logger.class, "log", PRIVATE, STATIC, FINAL)
                        .initializer("$T.getLogger($T.class)", ClassName.get(LoggerFactory.class),
                                ClassName.get(packageName + ".infrastructure.sns", name))
                        .build())
    ...
    private MethodSpec constructor(
        ...
        constructor.addParameter(SqsUtil.class, "sqsUtil");
    ...
    private static CodeBlock deadLetterConfig(EventHandlerConfig eventHandlerConfig) {
