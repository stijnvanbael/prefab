...
public class KafkaPrefabStreamProcessorAdapter<KI extends Key<KI>, VI extends Keyed<KI>, KO extends Key<KO>, VO extends Keyed<KO>> extends ContextualProcessor<KI, VI, KO, VO> {
