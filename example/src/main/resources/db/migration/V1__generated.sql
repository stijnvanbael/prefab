...
remaining_value DECIMAL (19, 4) NOT NULL, PRIMARY KEY(id)
);

CREATE TABLE invoice (
id VARCHAR (255) NOT NULL,
version INTEGER NOT NULL,
total DECIMAL (19, 4), PRIMARY KEY(id)
);
...
price DECIMAL (19, 4) NOT NULL, PRIMARY KEY(sale, sale_key)
);
...
gift_voucher VARCHAR (255) REFERENCES gift_voucher(id), PRIMARY KEY(sale, sale_key)
);
